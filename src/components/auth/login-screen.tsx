...
export function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const nextMessage = data?.message ?? 'Login not allowed for this number.';
      setMessage(nextMessage);
      if (nextMessage) {
        Alert.alert('Login', nextMessage);
      }
    } catch (error) {
      ...
      <KeyboardAvoidingView
        ...
        <View style={styles.container}>
          <View style={[styles.card, { backgroundColor: palette.card, borderColor: palette.border }]}>
            <View style={[styles.logoShell, { borderColor: palette.border, backgroundColor: palette.input }]}>
              <Image
            ...
            <View style={styles.form}>
              ...
              <Pressable
                ...
                style={({ pressed }) => [
                  styles.button,
                  { backgroundColor: palette.accent, opacity: pressed || loading ? 0.88 : 1 },
                ]}>
                {loading ? (
